...
import com.example.demo.service.impl.UserTransferServiceImpl;
...
public class ApplicationController {
	...
	private final UsageLogCsvService csvService;
	private final UserTransferServiceImpl userTransferService;
	private final GroupService groupService;
	private final DepartmentService departmentService;

	public ApplicationController(ApplicationService applicationService, UserRepository userRepository,
			UsageLogCsvService csvService, UserTransferServiceImpl userTransferService,
			GroupRepository groupRepository, GroupService groupService, DepartmentService departmentService) {
	...
	public ResponseEntity<byte[]> exportCsv(
			@RequestParam(name = "groupIds", required = false) List<Long> groupIds, Model model) {

		// groupIds が null or empty → 全社扱い
	...
	public String transfer(
		...
		userTransferService.transferUser(userId, newGroupId);
