...
public class ApplicationServiceImpl implements ApplicationService {
	...
	public Request createNewRequest(Request request) {
		if (request.getHalfDay() == null)
			request.setHalfDay(false);
		if (request.getSpApply() == null)
			request.setSpApply(false);
		if (request.getApply() == null)
			request.setApply(0);
	...
	//	@Override
	//	public List<UsageLog> findUsageLogs(
	//			LocalDate startDate,
	//			LocalDate endDate,
	//			String filterType,
	//			Integer groupId,
	...
	//
	//		// デフォルト（会社全体）
	//		if (filterType == null || filterType.equals("company")) {
	//			return logRepository.findByUsageDateBetween(startDate, endDate);
	//		}
	//
	//		// グループ別
	...
	//
	//			if (groupId == null) {
	//				throw new IllegalArgumentException("groupId が指定されていません");
	//			}
	//
	//			return logRepository
	//					.findByUsageDateBetweenAndGroupId(startDate, endDate, groupId);
	//		}
	//
	//		// 個人別
	...
	//				throw new IllegalArgumentException("userId が指定されていません");
	//			}
	//
	//			return logRepository
	//					.findByUsageDateBetweenAndUserId(startDate, endDate, userId);
	//		}
	//
	//		// 該当しない場合
	//		throw new IllegalArgumentException("filterType が不正です: " + filterType);
	//	}
