...
public interface ApplicationService {
   ...
   // 申請機能
   Request createNewRequest(Request request, boolean ignoreLimit);
   ...
   void updateApprovalStatus(Long requestId, boolean approved, String approverId);

   List<Request> findAll();

   List<RequestDetailDto> findAllWithNames();
   ...
   void updateAllRoles(List<String> displayedUserIds, List<String> approverList, List<String> adminList);
